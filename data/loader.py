...
class MultiTaskDataset(Dataset):
    ...
    def __init__(self, mode, data_dir, data_list_1, data_list_2, output_size,
        ...
        print('-'*50)
        print(f'{mode} MultiTaskDataset Init !')
        print('-'*50)
        ...
        print('-'*30)
        print('self.data_dir:', self.data_list_1)
        print('self.data_list_1:', self.data_list_1)
        print('self.data_list_2:', self.data_list_2)
        print('-'*30)
        ...
        print('len(self.label_list_1):', len(self.label_list_1))
        print('len(self.label_list_2):', len(self.label_list_2))
        print('-'*30)
